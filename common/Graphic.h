...
VOID getRectImage(IN UINTN x1,IN UINTN y1,IN UINTN Width,IN UINTN Height ,IN OUT EFI_GRAPHICS_OUTPUT_BLT_PIXEL *ImageBuffer);
VOID putRectImage(IN UINTN x1,IN UINTN y1,IN UINTN Width,IN UINTN Height ,IN OUT EFI_GRAPHICS_OUTPUT_BLT_PIXEL *ImageBuffer);
...
VOID putImageLine(IN UINTN x,IN UINTN y,IN UINTN Width,IN UINTN Height,IN UINTN imageX1,IN UINTN imageY1,IN UINTN X2,IN UINTN Y2,IN UINTN maxX,IN UINTN maxY,IN EFI_GRAPHICS_OUTPUT_BLT_PIXEL *ImageBuffer);
//Debug function
