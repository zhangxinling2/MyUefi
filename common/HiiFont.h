...
EFI_STATUS putHiiFontStr(UINTN x,UINTN y,EFI_STRING String,CHAR16* fontName,EFI_GRAPHICS_OUTPUT_BLT_PIXEL *fontForegroundColor,EFI_GRAPHICS_OUTPUT_BLT_PIXEL *fontBackgroundColor);
